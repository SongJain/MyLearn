...
import com.SongJian.View.AddRelation2.Reset;
import com.SongJian.View.AddRelation2.re;

public class AddRelation3 {
	...
	JComboBox<String> userchoicer1 = new JComboBox<>(chars);
	...
	public void init()
	{
		...
		userchoicer1.setFont(font);
		
		sure.addActionListener(w);
		sure.setBounds(30, 200, 100, 35);
		reset.setBounds(150, 200, 100, 35);
		returnto.setBounds(290, 200, 100, 35);
		textname2.setBounds(420, 30, 100, 35);
		userchoicer.setBounds(240, 30, 100, 35);
		userchoicer1.setBounds(560, 30, 100, 35);
		textname1.setBounds(30, 30, 100, 35);
		is.setBounds(380, 30, 100, 35);
		de.setBounds(150, 30, 100, 35);
		
		returnto.addActionListener(r);
		reset.addActionListener(re);
		
		contentPanel.add(userchoicer1);
	...
	class Write implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			s4 = (String) userchoicer1.getSelectedItem();
