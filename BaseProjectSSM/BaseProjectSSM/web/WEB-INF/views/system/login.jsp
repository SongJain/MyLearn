...
<div id="particles-js">
    <div class="login" style="display: block;">
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="../resource/admin/login/images/checkp.png"></div>
            <div class="login-center-input">
...
<script src="../resource/admin/login/js/jquery-1.8.0.min.js"></script>
<script type="text/javascript">
    ...
    function changeCpacha(){
        $("#cpacha-img").attr("src",'get_cpacha?vl=4&w=110&h=40&type=loginCpacha&t=' + new Date().getTime());
    }
