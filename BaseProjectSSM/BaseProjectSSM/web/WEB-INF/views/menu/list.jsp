    ...
    <td><input type="text" name="name" class="wu-text easyui-validatebox" data-options="required:true, validType:'repeat', missingMessage:'请输入菜单名称'"/></td>
    </tr>
    <tr>
    ...
    <td><input type="text" id="add-icon" name="icon" class="wu-text easyui-validatebox" data-options="required:true, validType:'repeat', missingMessage:'请输入菜单图标'" />
    ...
    <%--修改窗口    --%>
        ...
        <tr>
        <td width="60" align="right">菜单名称:</td>
        <td><input type="text" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, validType:'repeat', missingMessage:'请输入菜单名称'"/></td>
        </tr>
        <tr>
        <td align="right">上级菜单:</td>
        <td>
        <select name="parentId" id="edit-parentId" class="easyui-combobox" panelHeight="auto" style="width:268px">
        <option value="0">顶级分类</option>
        <c:forEach items="${topList }" var="menu">
            <option value="${menu.id}">${menu.name}</option>
        </c:forEach>
        ...
        <tr>
        <td valign="top" align="right">菜单图标：</td>
        <td><input type="text" id="edit-icon" name="icon" class="wu-text easyui-validatebox" data-options="required:true, validType:'repeat', missingMessage:'请输入菜单图标'" />
        <a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="selectIcon()" plain="true">选择</a>
        </td>
        </tr>
        </table>
    ...
    */
    ...
    {
    $.messager.alert('信息提示',data.message,'添加失败！','info');
    }
    }
    });
    }
